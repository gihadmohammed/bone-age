# Generated by Django 4.1.7 on 2023-05-01 09:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Guest',
            fields=[
                ('GuestID', models.IntegerField(default=50, primary_key=True, serialize=False, unique=True)),
                ('CreatedDate', models.DateField(default=datetime.datetime(2023, 5, 1, 11, 11, 48, 207912), editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Role', models.CharField(choices=[('ADMIN', 'Admin'), ('CUSTOMER', 'Customer'), ('VENDOR', 'Vendor')], default='ADMIN', max_length=20)),
                ...
                ('PromoCodeUsed', django_mysql.models.ListCharField(models.CharField(max_length=100, null=True), max_length=10100, null=True, size=100)),
